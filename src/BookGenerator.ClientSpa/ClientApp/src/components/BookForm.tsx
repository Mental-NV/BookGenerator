                ...
                <form className="flex flex-row flex-nowrap" onSubmit={handleSubmit} role="form">
                    ...
                    {!isFormDisabled &&
                        <button type="submit" id="generateButton"
                            ...
                            className="h-10 w-24 mx-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
                            Generate
                        </button>
                    }
                    {isFormDisabled &&
                        <button type="submit" id="generateButton"
                            ...
                            className="h-10 w-24 mx-1 py-2.5 px-5 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center justify-center">
